  ...
  <div class="main template-page">
    ...
    <div v-else class="section-table">
      <el-table v-if="tableData.total" :data="tableData.list" :tooltip-effect="tooltipEffect">
        ...
        <el-table-column prop="fee" label="费用" show-overflow-tooltip></el-table-column>
        <el-table-column prop="category_id" label="分类编号" show-overflow-tooltip></el-table-column>
