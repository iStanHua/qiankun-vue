  ...
  <div class="main history-page">
    ...
    <div v-else class="section-table">
      <el-table v-if="tableData.total" :data="tableData.list" :tooltip-effect="tooltipEffect">
        ...
        <el-table-column prop="operators" label="运营商" show-overflow-tooltip></el-table-column>
        <el-table-column prop="device" label="设备信息" show-overflow-tooltip></el-table-column>
        <el-table-column prop="agent" label="用户代理" show-overflow-tooltip></el-table-column>
